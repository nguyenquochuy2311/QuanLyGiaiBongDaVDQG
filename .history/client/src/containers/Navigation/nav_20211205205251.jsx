import { NavLink, Link,useHistory , R} from "react-router-dom";
          ...
          <div className="container-fluid nav__container">
           {/* logo */}
              ...
              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                <div className="col col-xl-7 col-lg-9 col-md-9">
                  <div className="row">
                    ...
                    <div className="col adminQuanLy " style={{display: 'none'}}>
                      <li className="nav-item">
                        <NavLink
                          to="/admin"
                          addClassName="active"
            ...
            <div className="account">
              {user!==null ?   <Link to="/" onClick={removeUser} className="log__out " title="Đăng xuất" >
                <i className="bx bx-log-out"></i>
              </Link> : <ul className="account-list activeted">
