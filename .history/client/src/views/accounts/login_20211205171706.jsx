...
const Login = () => {
  ...
  async function Login() {
    ...
    try {
      ...
      componentDidMount(){
         HiddenLogin = document.querySelector(".account-list") .style.display = "none";
          ShowLogout = document.querySelector(".log__out");
   ShowAdmin = document.querySelector(".adminQuanLy");
