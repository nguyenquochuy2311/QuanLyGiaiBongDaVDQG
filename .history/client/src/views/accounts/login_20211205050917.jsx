...
const Login = () => {
  ...
  const HiddenLogin = document.querySelectorAll('.account .account-list')
  const ShowLogout = document.querySelector('.log__out')

   console.log(HiddenLogin.classList);
  //  console.log(logout);

   function handleShow(){
    HiddenLogin.classList.add(".activeted");
    ShowLogout.classList.remove(".activeted");
