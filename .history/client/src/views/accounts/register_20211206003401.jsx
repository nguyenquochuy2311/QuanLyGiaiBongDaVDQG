...
const Register = () => {
  ...
  const validateUserPassword = (e) => {
    ...
    // console.log(">>>>>>>>>>>>" + email + " use" + String(username).length + " " + password);
    if (String(username).length > 4 && String(password).length > 6) {
        ...
        <Form className="register-form form">
          ...
          <div className="box">
            <input
              ...
              onInput={(e) => validateUserPassword(e.target.value)}
            />
