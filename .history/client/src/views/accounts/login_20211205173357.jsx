...
const Login = () => {
  ...
  const ShowLogout = document.querySelector(".log__out");
  ...
  async function Login() {
    ...
    try {
      ...
      function hisandleShow() {
        // HiddenLogin.addEventListener('')
        ShowLogout.classList.add(".activeted");
        HiddenLogin.classList.remove(".activeted");

        result.Role === 1
          ? ShowAdmin.classList.add(".activeted")
          : ShowAdmin.classList.remove(".activeted");
      }
      ...
      if (result.status === "success") {
        history.push("/");
        // handleShow();
        setLogin( document.querySelector(".account-list").style.display='none')  
        setLogout( document.querySelector(".log__out").style.display='block')

        setShowAdmin( document.querySelector(".adminQuanLy").style.display='block')
