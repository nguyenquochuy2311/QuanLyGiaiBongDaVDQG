  ...
  return (
    <Helmet title="Trang Chủ" className="home component">
      ...
      <div className="home-matchSchedule">
        ...
        <table className="list-group list-group-flush home-matchSchedule-list">
          {match.slice(0,10).map((match, index) => (
            <tr key={index} className="list-group-item team-item ">
              <td className="team-item-name">{match.TenDoi1}</td>
              <td>VS</td>
              <td className="team-item-name">{match.TenDoi2}</td>
              <td className="time-item-match">
                {match.ThoiGian}
                {/* <p className="time-item-match-day">{match.day}</p> */}
              </td>
              <td className="place-match">{match.SanDau}</td>
              {/* <p>
