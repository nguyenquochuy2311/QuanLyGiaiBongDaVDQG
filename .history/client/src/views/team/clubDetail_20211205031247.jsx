...
const TeamDetail = (props) => {
  ...
  let title = InfoPlayer.find((e) => to_slug(e.clb.TenCLB) === slug);
                        ...
                        <img
                          src={
                            require(`../../assets/img/AnhCauthu/${
                              ...
                              e.AnhDaiDien ?   e.AnhDaiDien: bgCard
                              
                              === "Anh_HAGL_NguyenHuuT uan"
                                ? "Anh_HAGL_VuVanThanh"
                                : e.AnhDaiDien
                            }${".jpg" || ".png"}`).default ? bgCard :
                            bgCard
                          }
                          alt="not found"
                        />
