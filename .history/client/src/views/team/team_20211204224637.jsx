...
const Team = () => {
  ...
  async function getClb() {
    let result = await fetch("http://127.0.0.1:8000/api/clb/1");
    result = await result.json();
    setClb(result);
    console.log(result);
  }
          ...
          {clb.map((e, index) =>(
            ...
            >
              ...
              >
                ...
                >
                  <img src={e.img} className="card-img-top" alt="not found" />
                  {/* {e.children} */}
                  <div className="card-body">
                    <img src={e.logo} alt="not-found" className="card-logo" />
