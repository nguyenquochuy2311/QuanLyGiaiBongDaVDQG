        ...
        <div className="row">

          {
            clb.map((e,index)=>(
                ...
                >
                  <Link style={{width: '280px'}}  className="card__item" to={`/doi-bong/${to_slug(e.TenCLB)}`}>
                    <CardTeam
                      ...
                      location={e.TruSo}
                    >
                       { card_team_data.getAllCards().map(item => (
                     <>
                    <img src={item.img} className="card-img-top" alt="not found" />
                    <img src={item.img} alt="not-found" className="card-logo" />
                     </>
                   )) } 
                   { card_team_data.getAllCards().map(item => (
                     <>
