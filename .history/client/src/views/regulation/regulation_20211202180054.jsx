  ...
  return (
    <Helmet title="Quy Định">
      ...
      <section className="body-content">
        ...
        <h3 className="body-text">Lập phương án tổ chức:</h3>
        <p>
          Đơn vị tổ chức phải căn cứ vào quy mô, kế hoạch nhiệm vụ và tính chất
          của giải để lập ra phương án tổ chức với các nội dung chủ yếu sau:
        </p>
        ...
        <h3  className="body-text">Lập cơ cấu tổ chức giải</h3>
        <p>
          Cơ cấu tổ chức giải phải phù hợp với quy mô và tình hình thực tế của
          giải thi đấu. Ví dụ các giai thi đấu quốc gia phải do UBTDTT quốc gia
          tổ chức , các giải thi đấu cấp tỉnh, thành sẽ do các sở TDTT tổ chức
          và các giải thi đấu với quy mô nhỏ hơn sẽ do các đơn vị cơ sở tổ chức
        </p>

        <h3  className="body-text">Phân công chức năng và nhiệm vụ của các bộ phận trong BTC giải</h3>
        <p>
          Các bộ phận phải căn cứ vào kế hoạch tổ chức giải và chức năng, nhiệm
          vụ đã được phân công để hợp tác và tương trợ lẫn nhau trong công việc
          nhằm hoàn thành tốt nhiệm vụ đã được giao.
        </p>
        <p>
          Đối với các giải thi đấu có quy mô vừa và nhỏ thì thông thường cơ cấu
          tổ chức và chức năng nhiệm vụ của từng bộ phận thường được bố trí như
          sau:
        </p>

        <p style={{color: 'red', fontSize:'1.2rem', fontWeight:'500'}}>Ban tổ chức</p>
        <ul className="body-text-list">
