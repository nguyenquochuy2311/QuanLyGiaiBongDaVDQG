...
export default function AddResult() {
  ...
  const [BanThDoi1, setBanThDoi1] = useState("");
  ...
  async function addResult() {
    ...
    formData.append("BanThDoi1", BanThDoi1);
    ...
    console.log(BanThDoi1, XuPhat, BanThang, XuPhat, BanThang);
          ...
          {/* <Form.Group className="mb-3" controlId="form------">
            ...
            <Form.Group className="mb-3" controlId="form------">
              ...
              <Form.Control
                ...
                onChange={(e) => setBanThDoi1(e.target.value)}
              />
              <Form.Text className="text-muted"></Form.Text>
              <Form.Label className="err">--</Form.Label>
              <Form.Label className="err">{val.BanThDoi1}</Form.Label>
            </Form.Group>
            ...
            {/* <Link
              to={
                BanThDoi1 && idToTT && ThoiGian && XuPhat && BanThang
                  ?
                  "/admin"
                  : "#" 
              }
