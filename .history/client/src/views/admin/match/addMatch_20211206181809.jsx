...
export default function AddMaaddMatch() {
  ...
  async function addMatch() {
    ...
    console.log(TenDoi1, VongDau, SanDau, id, ThoiGian);
      ...
      <Row style={{ paddingTop: "50px", background: "#ccc" }}>
        ...
        <Col md={{ span: 4, offset: 4 }}>
          <Form className="form">
            ...
            <Form.Group className="mb-3" controlId="form------">
              <Form.Label>
                <b>Chọn id câu lạc bộ</b>
              </Form.Label>
              <Form.Control
                id="id"
                type="file"
                placeholder="Chọn id câu lạc bộ"
                onChange={(event) => setid(event.target.files[0])}
              />

              <Form.Text className="text-muted">-</Form.Text>
              <Form.Label className="err">{val.id}</Form.Label>
            </Form.Group>
            <Form.Group className="mb-3" controlId="form------">
              <Form.Label>
                <b>Trụ sở</b>
            ...
            {/* <Link
              to={
                TenDoi1 && id && ThoiGian && VongDau && SanDau
                  ?
                  "/admin"
                  : "#" 
              }
