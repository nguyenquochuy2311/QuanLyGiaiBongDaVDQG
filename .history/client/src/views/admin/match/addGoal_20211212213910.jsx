...
export default function AddGoal() {
  ...
  async function addGoal() {
    ...
    console.log(idCau, VongDau, SanDau, idToTT, ThoiGian);
          ...
          <Form className="form">
            <Form.Group className="mb-3" controlId="form------">
              ...
              <Form.Control
                ...
                onChange={(e) => setidCau(e.target.value)}
              />
              <Form.Text className="text-muted"></Form.Text>
              <Form.Label className="err">--</Form.Label>
              <Form.Label className="err">{val.idCau}</Form.Label>
            </Form.Group>
            ...
            {/* <Link
              to={
                idCau && idToTT && ThoiGian && VongDau && SanDau
                  ?
                  "/admin"
                  : "#" 
              }
