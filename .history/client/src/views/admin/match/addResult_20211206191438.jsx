...
export default function AddResult() {
  ...
  const [XưPhat, setXưPhat] = useState("");
          ...
          <Form className="form">
            ...
            <Form.Group className="mb-3" controlId="form------">
              ...
              <Form.Control
                ...
                onChange={(e) => setXưPhat(e.target.value)}
              />
              <Form.Text className="text-muted">------</Form.Text>
              <Form.Label className="err">{val.XưPhat}</Form.Label>
            </Form.Group>
            <Form.Group className="mb-3" controlId="form------">
              <Form.Label>
                <b>Sân vận động</b>
            ...
            {/* <Link
              to={
                BanThangDoi1 && idToTT && ThoiGian && XưPhat && SanDau
                  ?
                  "/admin"
                  : "#" 
              }
