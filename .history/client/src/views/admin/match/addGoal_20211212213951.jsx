...
export default function AddGoal() {
  ...
  async function addGoal() {
    ...
    formData.append("idKetQua", idKetQua);
    formData.append("ThoiDiem", ThoiDiem);
    formData.append("LoaiB", LoaiB);
    formData.append("idToTT", idToTT);
    formData.append("ThoiGian", ThoiGian);
    

    console.log(idCauThu, ThoiDiem, LoaiB, idToTT, ThoiGian);
          ...
          <Form className="form">
            ...
            <Form.Group className="mb-3" controlId="form------">
              ...
              <Form.Control
                ...
                onChange={(e) => setLoaiB(e.target.value)}
              />
              <Form.Text className="text-muted">------</Form.Text>
              <Form.Label className="err">{val.LoaiB}</Form.Label>
            </Form.Group>
            <Form.Group className="mb-3" controlId="form------">
              <Form.Label>
            ...
            {/* <Link
              to={
                idCauThu && idToTT && ThoiGian && ThoiDiem && LoaiB
                  ?
                  "/admin"
                  : "#" 
              }
