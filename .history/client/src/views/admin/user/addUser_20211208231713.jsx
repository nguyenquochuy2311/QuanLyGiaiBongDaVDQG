...
export default function AddPlayer() {
  ...
  const [userNamr, setuserNamr] = useState("");
  ...
  async function addPlayer() {
    ...
    formData.append("userNamr", userNamr);
    ...
    console.log(idCLB, SoAo, ChieuCao, LoaiCauThu, ViTri, userNamr, date, img);
          ...
          <Form className="form">
            <Form.Group className="mb-3">
              ...
              <Form.Control
                ...
                onChange={(e) => setuserNamr(e.target.value)}
                maxlength="30"
              />
              <Form.Text className="text-muted"></Form.Text>
              <Form.Label className="err">--</Form.Label>
              <Form.Label className="err">{val.userNamr}</Form.Label>
            </Form.Group>
            ...
            <Button onClick={
              ...
              addPlayer} variant="outline-success">
              <b>Thêm ngay</b>
            </Button>{" "}
            <br />
            <br />
