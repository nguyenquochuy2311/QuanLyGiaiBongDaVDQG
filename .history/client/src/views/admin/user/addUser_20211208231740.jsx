...
export default function AddPlayer() {
  ...
  const [password, setPassword]setNumberClother] = useState("");
  ...
  async function addPlayer() {
    ...
    formData.append("password, setPassword]", password, setPassword]);
    ...
    console.log(Role, password, setPassword]ChieuCao, LoaiCauThu, ViTri, userName, date, img);
