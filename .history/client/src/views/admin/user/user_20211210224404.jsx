...
const AdminAccount = () => {
  ...
  async function getInfoUser(id) {
    let result = await fetch("http://127.0.0.1:8000/api/auth/user-by-id/" + id);
  ...
  async function editUser(id) {
    ...
    let result = await fetch(
      "http://127.0.0.1:8000/api/auth/update/" + id,
      {
        method: "post",
        headers: {
          Authorization: "Bearer " + taikhoan.access_token,
    ...
    if (result.status !== 200) {
      ...
      setTimeout(() => history.push("/admin/tai-khoan"), 1000);
      store.addNotification({
              ...
              <tr key={e.UID}>
                ...
                <td>
                  ...
                  <button
                    ...
                    onClick={() => userID = e.UID && getInfoUser(e.UID)}
                    // value= {e.UID}
                  >
                    Sửa
                  </button>
