  ...
  async function addPlayer() {
    ...
    if (result.status !==200) {
      ...
      store.addNotification({
        title: "Thêm  thất bại !",
        message: "Hãy kiểm tra lại thông tin của bạn, đảm bảo thông tin hợp lệ và không bị trùng !",
        type: "danger",
        insert: "top",
        container: "top-right",
      ...
      <Row style={{ paddingTop: "50px", background: "#ccc" }}>
        ...
        <Col md={{ span: 4, offset: 4 }}>
          <Form className="form">
            ...
            <Form.Select  onChange={(e) => setViTri(e.target.value)} aria-label="Chọn loại cầu thủ">
                    <option>Hãy chọn loại cầu thủ</option>
                    <option value="Tiền đạo">Tiền đạo</option>
                    <option value="Tiền vệ">Tiền vệ</option>
                    <option value="Trung vệ">Trung vệ</option>
                    <option value="Hậu vệ">Hậu vệ</option>
                    <option value="Thủ môn">Phương tiện</option>
