...
export default function AddClub() {
  ...
  const [height, setNamehie] = useState("");
  ...
  async function addClub() {
    ...
    console.log(name, name_refe, height, image, location);
          ...
          <Form.Group className="mb-3" controlId="formBasicEmail">
            ...
            <Form.Group className="mb-3" controlId="form------">
              ...
              <Form.Control
                ...
                onChange={(e) => setNamehie(e.target.value)}
              />
              <Form.Text className="text-muted">------</Form.Text>
              <Form.Label className="err">{val.hie}</Form.Label>
            </Form.Group>
            ...
            <Link
              onClick={addClub}
              to={
                name && image && location && name_refe && height
                  ? "/admin"
                  : "#"
              }
            >
