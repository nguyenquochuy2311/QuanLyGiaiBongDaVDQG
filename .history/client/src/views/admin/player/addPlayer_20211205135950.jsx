...
export default function AddClub() {
  ...
  const [number_clo, setNumberClother] = useState("");
  ...
  async function addClub() {
    ...
    formData.append("number_clo", number_clo);
    formData.append("height", height);
    formData.append("image", image);
    formData.append("location", location);

    console.log(name, number_clo, height, image, location);
        ...
        <Col md={{ span: 4, offset: 4 }}>
          ...
          <Form.Group className="mb-3" controlId="formBasicEmail">
            ...
            <Form.Group className="mb-3" controlId="form------">
              ...
              />
              <Form.Text className="text-muted">------</Form.Text>
              <Form.Label className="err">{val.number_clo}</Form.Label>
            </Form.Group>
            ...
            <Form.Select  onChange={(e) => setPlayerType(e.target.value)} aria-label="Chọn loại cầu thủ">
            ...
            <Link
              onClick={addClub}
              to={
                name && image && location && number_clo && height
                  ? "/admin"
                  : "#"
              }
            >
