...
export default function EditPlayer() {
  ...
  return (
    <Helmet title="Chỉnh sửa cầu thủ">
      <AdminHeader />
      <Header title="Chỉnh sửa cầu thủ" />
      <ReactNotification />
        ...
        <Col md={{ span: 4, offset: 4 }}>
          <Form className="form">
            ...
            >
              ...
              {clb.map((item) => (
                <option key={item.idCLB} value={item.idCLB}>{item.TenCLB}</option>
              ))}
            </Form.Select>
            <br />
            <br />
            ...
            >
              <option value={data.ViTri}>{data.ViTri}</option>
            ...
            >
              ...
              <option value={data.LoaiCauThu}>{data.LoaiCauThu}</option>
            ...
            <Button
              onClick={() =>
                ...
                //  alert('Thông tin chưa đầy đủ hoặc không hợp lệ')
