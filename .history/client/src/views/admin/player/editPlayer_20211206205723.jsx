...
export default function EditPlayer() {
  ...
  async function editPlayer(id) {
    ...
    let result = await fetch("http://127.0.0.1:8000/api/auth/cauthu/update/"+ id, {
      method: "put",
      headers: {
    ...
    console.log("Trả về editPlayer>>>>>>> :", result);
    ...
    if (result.status !== 200) {
      ...
      store.addNotification({
        ...
        message:
          "Hãy kiểm tra lại thông tin của bạn, đảm bảo thông tin hợp lệ và không bị trônhs !",
        type: "danger",
        insert: "top",
        container: "top-right",
      ...
      <Row style={{ paddingTop: "50px", background: "#ccc" }}>
        ...
        <Col md={{ span: 4, offset: 4 }}>
          <Form className="form">
            ...
            <br />
            <br />
            <Button onClick={editPlayer} variant="outline-success">
              <b>Thêm ngay</b>
            </Button>{" "}
            <br />
            <br />
