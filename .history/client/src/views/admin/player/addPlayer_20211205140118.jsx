...
export default function AddPlaer() {
  ...
  async function addPlaer() {
    ...
    console.log(name, number_clother, height, image, role);
    ...
    console.log("Trả về addPlaer>>>>>>> :", result);
        ...
        <Col md={{ span: 4, offset: 4 }}>
          ...
          <Form.Group className="mb-3" controlId="formBasicEmail">
            ...
            <Link
              onClick={addPlaer}
              to={
                name && image && role && number_clother && height
                  ? "/admin"
                  : "#"
              }
            >
