...
async function deleteCLb(id) {
  await fetch("http://localhost:8000/api/deleteCLb/" + id, {
    method: "DELETE",
  });
                ...
                (e) =>
                  e.title === item.TenCLB && (
                    <tr key={index}>
                      ...
                      <td>
                        <button onClick={()=> deleteCLb()} className="remove">Xóa</button>
                      </td>
                    </tr>
                  )
              )
