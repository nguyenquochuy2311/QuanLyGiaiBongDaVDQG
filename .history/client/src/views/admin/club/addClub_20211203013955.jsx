        ...
        <Col md={{ span: 4, offset: 4 }}>
          <Form className="form">
            ...
            <Form.Group className="mb-3" controlId="form------">
              <Form.Label>
                <b>Giá mới sản phẩm</b>
              </Form.Label>
              <Form.Control
                maxlength="11"
                type="number"
                placeholder="Hãy nhập giá mới sản phẩm"
            ...
            <Form.Group className="mb-3" controlId="form------">
              ...
              <Form.Control
                maxlength="11"
                type="number"
                placeholder="Hãy nhập giá cũ sản phẩm"
            ...
            <Form.Group className="mb-3" controlId="form------">
              <Form.Label>
                <b>Số lượng hàng sẵn có</b>
              </Form.Label>
              <Form.Control
                type="number"
                placeholder="Số lượng hàng sẵn có"
