              ...
              (item, index) => (
                ...
                <tr key={item.idCLB}>
                  ...
                  <td>
                    ...
                    <img variant="top" src={"http://127.0.0.1:8000/image/product/" + item.Logo} alt={data.image} style={{width:"150px"}} />
                      <img src={require(`../../../../../server/public/uploads/clb/${item.Logo}`)} alt="not found" />
                      {/* {
                      card_team_data
                        .getAllCards()
                        .map((e) =>
