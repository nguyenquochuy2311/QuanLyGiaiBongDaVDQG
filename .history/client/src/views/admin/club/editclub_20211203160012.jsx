        ...
        <Row style={{ paddingTop: "50px", background: "#ccc" }}>
            ...
            <Form className="form">
                ...
                <Form.Group className="mb-3" controlId="form------">
                    ...
                    <Form.Control maxlength="11" type="text" placeholder="Hãy nhập tên sân vận động" id="price_new" defaultValue={data.stadium} />
                    <Form.Text className="text-muted">
                        ------
                    </Form.Text>
                ...
                <Form.Group className="mb-3" controlId="form------">
                    ...
                    <Form.Control maxlength="11" type="text" placeholder="Hãy nhập tên huấn luyện viên" id="price_old" defaultValue={data.hlv}/>
                    <Form.Text className="text-muted">
                        ------
                    </Form.Text>
                ...
                <Form.Group className="mb-3" controlId="form------">
                    ...
                    <Form.Control maxlength="11" type="number" placeholder="Số trận thắng" id="discount" defaultValue={data.win}/>
                    <Form.Text className="text-muted">
                        ------
                    </Form.Text>
                ...
                <Form.Group className="mb-3" controlId="form------">
                    ...
                    <Form.Control  type="number" placeholder="Số trận hòa" id="detail" defaultValue={data.draw}/>
                    <Form.Text className="text-muted">
                        -
                    </Form.Text>
                ...
                <Form.Group className="mb-3" controlId="form------">
                    ...
                    <Form.Control  type="number" placeholder="Số trận thua" id="quantity" defaultValue={data.loss} />
                    <Form.Text className="text-muted">
                        -
                    </Form.Text>
