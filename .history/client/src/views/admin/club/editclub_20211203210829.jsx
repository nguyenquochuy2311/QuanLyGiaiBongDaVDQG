...
function EditClub(props) {
  ...
  async function getHlv() {
    let result = await fetch("http://localhost:8000/api/hlv/" + id);
  ...
  async function showID() {
    let result = await fetch("http://localhost:8000/api/clb/1");
    result = await result.json();
    Setclb(result);
    console.log(">>>>>>>>>>>>>>: " + result);
  }
