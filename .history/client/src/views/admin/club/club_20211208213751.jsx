              ...
              <tr key={item.idCLB}>
                ...
                <td>
                  <picture className="img logo">
                    {/* { card_team_data.getAllCards().map((e) => { 

return e.title === a ? e.img : "";
})
                    <source srcSet = {findImg(item.TenCLB)} /> */}
                    {/* <img src={LogoSoccer} alt="not found" /> */}
                    <img src={'http://127.0.0.1:8000/uploads/clb'+ item.Logo} alt="not found" />
