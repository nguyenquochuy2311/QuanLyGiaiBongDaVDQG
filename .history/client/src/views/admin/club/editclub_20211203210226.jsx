...
//lay hlv
    ...
    async function editClub(){
        ...
        let result = await fetch("http://127.0.0.1:8000/api/hlv/" + id, {
            method: "post",
            body: formData,
        ...
        <Row style={{ paddingTop: "50px", background: "#ccc" }}>
            ...
            <Form className="form">
                ...
                <Form.Group className="mb-3" controlId="form------">
                    ...
                    <Form.Control disabled={true} maxlength="11" type="text" placeholder="Hãy nhập tên sân vận động" id="stadium" defaultValue={data.stadium} />
                    <Form.Text className="text-muted">
                        ------
                    </Form.Text>
                ...
                <Form.Group className="mb-3" controlId="form------">
                    ...
                    <Form.Control disabled={true}  maxlength="11" type="text" placeholder="Hãy nhập tên huấn luyện viên" id="hlv" defaultValue={data.hlv}/>
                    <Form.Text className="text-muted">
                        ------
                    </Form.Text>
