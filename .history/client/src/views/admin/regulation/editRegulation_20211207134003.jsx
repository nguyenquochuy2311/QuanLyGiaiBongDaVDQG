...
function EditDiemSo() {
  ...
  async function editDiemSo(id) {
    ...
    // console.log("Trả về thong tin :", DiemThang.value + DiemHoa.value + DiemThua.value);

    if (result.status !== 200 &&DiemThang.value>DiemHoa.value&&DiemHoa.value>DiemThua.value) {
      ...
      <Row style={{ paddingTop: "50px", background: "#ccc" }}>
        ...
        <Col md={{ span: 4, offset: 4 }}>
          <Form className="form">
            ...
            {/* <Link
            > */}
            <Button onClick={()=>editDiemSo(data.idQUYDINHDIEMSO)} variant="outline-success">
              <b>Sửa ngay</b>
            </Button>{" "}
            {/* </Link> */}
            <br />
