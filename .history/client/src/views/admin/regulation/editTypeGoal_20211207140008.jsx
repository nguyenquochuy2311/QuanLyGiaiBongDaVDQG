...
function EditDiemSo() {
  ...
  const LoaiBan = document.getElementById("LoaiBan");
  ...
  async function editDiemSo(id) {
    ...
    formData.append("LoaiBan", LoaiBan.value);
  ...
  function isValid() {
    return BatDau.value <= KetThuc.value || KetThuc.value <= DiemThua.value
      ? false
      : true;
  }
        ...
        <Col md={{ span: 4, offset: 4 }}>
          <Form className="form">
            <Form.Group className="mb-3" controlId="formBasicEmail">
              ...
              <Form.Label className="err">{val.LoaiBan}</Form.Label>
            </Form.Group>
            <Form.Group className="mb-3" controlId="formBasicEmail">
              <Form.Label>
                <b>Điểm thắng</b>
