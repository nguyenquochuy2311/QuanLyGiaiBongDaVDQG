...
function EditBanThang() {
  ...
  const ThoiDiemKetThuc = document.getElementById("ThoiDiemKetThuc");
  ...
  async function editBanThang(id) {
    ...
    console.log(">>>>>>>>>>>>>>: " + JSON.stringify(result.status) +
      ThoiDiemKetThuc.value +
      ThoiDiemBatDau.value)
  ...
  //check valid
  function isValid() {
    ThoiDiemBatDau.value >= ThoiDiemKetThuc.value ? return true : return true;
}
