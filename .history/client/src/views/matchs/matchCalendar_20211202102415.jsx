        ...
        <div className="table">
          ...
          <table className="table__content">
            ...
            </tr>
            {
              ...
              card_team_data.getAllCards().map(element =>(
                refe.map((e) =>
                    e.idToTT === item.idToTT && (element.title===item.TenDoi1)&&   (
                      <tr key={item.idTD}>
                        <td>{n++}</td>
                        <td>{item.VongDau}</td>
                        <td>{item.ThoiGian}</td>
                        <td className="team__match         padding-left: 5px;
">

                          <div className="img_clb">
                            <img className='img logo' src={element.img} alt="not found" />
                          <p>{item.TenDoi1}</p>
                          </div>
                          <p >VS</p>
                          <div className="img_clb">
