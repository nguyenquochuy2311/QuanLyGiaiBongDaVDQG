...
// import AddRegulation from '../views/admin/regulation/addRegulation';
// import EditRegulation from '../views/admin/regulation/editRegulation';
...
import AddAccount from '../views/admin/user/user';
import DeleteAccount from '../views/admin/user/user';
