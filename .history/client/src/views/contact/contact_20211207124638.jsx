...
const Contact = () => {
  ...
  const result = {name.value,email,content};
  function Save() {
    localStorage.setItem("Thông tin liên hệ", JSON.stringify(result));
          ...
          <ol>
            ...
            <ul>
              <form action="" method="post" autocomplete="on">
                ...
                <div className="form-contact">
                  <input onClick={()=> Save} type="button" id="submit" value="gửi đi" onclick="" />
                </div>
              </form>
            </ul>
          </ol>
