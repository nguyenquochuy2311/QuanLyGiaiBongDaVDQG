            ...
            <li className="title">các câu hỏi thường gặp</li>
                <ul className="list__contact">
                    ...
                    <div className="content">
                        ...
                        <p> <p className="strong">Thử đặt lại mật khẩu của bạn.</p> Mật khẩu tạm thời sẽ được gửi đến hộp thư của bạn. Vui lòng cập nhật mật khẩu của bạn sau khi đăng nhập.</p>
                            
                        <p>Nếu bạn không nhận được lời nhắc mật khẩu, vui lòng kiểm tra thư mục Rác trong hộp thư đến của bạn và thêm <strong className="strong">noreply@mailout.users.premierleague.com</strong> vào sổ địa chỉ của bạn.</p>    
                    </div>
