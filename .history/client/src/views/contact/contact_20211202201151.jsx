            ...
            <li className="title">các câu hỏi thường gặp</li>
                <ul className="list__contact">
                    ...
                    <div className="content">
                        ...
                        <p>Nếu bạn không nhận được lời nhắc mật khẩu, vui lòng kiểm tra thư mục Rác trong hộp thư đến của bạn và thêm noreply@mailout.users.premierleague.com</strong> vào sổ địa chỉ của bạn.</p>    
                    </div>
