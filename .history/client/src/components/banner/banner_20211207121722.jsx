...
import { banner,banner,banner3 } from "../../assets/img";
const Ban = () => {
  return (
    <div className="row">
      <div
      ...
      >
        ...
        <div className="carousel-inner">
          ...
          <div className="carousel-item">
            <img className="d-block w-100 ban-img" src={banner} alt="Second slide" />
          </div>
          <div className="carousel-item">
            <img className="d-block w-100 ban-img" src={banner} alt="Third slide" />
          </div>
        </div>
        <a
